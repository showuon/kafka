...
public class Topic {
    ...
    public static final String CLUSTER_METADATA_REMOTE_TOPIC_NAME = "__cluster_metadata_remote";
    public static final TopicPartition CLUSTER_METADATA_TOPIC_PARTITION = new TopicPartition(
        CLUSTER_METADATA_TOPIC_NAME,
        0
    );

    public static final TopicPartition CLUSTER_METADATA_REMOTE_TOPIC_PARTITION = new TopicPartition(
            CLUSTER_METADATA_REMOTE_TOPIC_NAME,
            0
    );
