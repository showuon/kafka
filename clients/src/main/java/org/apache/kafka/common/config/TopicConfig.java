...
public class TopicConfig {
    ...
    public static final String REMOTE_COMPLETE_LOG_STORAGE_ENABLE_CONFIG = "remote.complete.storage.enable";
    public static final String REMOTE_LOG_DIR_CONFIG = "remote.complete.storage.dir";
