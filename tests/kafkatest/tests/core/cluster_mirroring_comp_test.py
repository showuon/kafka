...
class ClusterMirroringCompPlainTest(MirrorUtils, Test):
    ...
    def test_ule_mirroring(self, source_version, metadata_quorum):
        ...
        MirrorUtils.produce_records(self.source_kafka, topic, 1, self.source_client_node,
        ...
        MirrorUtils.wait_for_log_convergence(self.source_kafka, self.dest_kafka, topics)
        ...
        MirrorUtils.produce_records(self.source_kafka, topic, 2, self.source_client_node,
                             bootstrap_servers=MirrorUtils.broker_bootstrap(src_broker0))
        ...
        MirrorUtils.wait_mirror_state(self.dest_kafka, mirror_name, "STOPPED", [topic])
