...
public class EosBetaUpgradeIntegrationThreeTest {
    ...
    public void shouldUpgradeFromEosAlphaToEosBeta() throws Exception {
        ...
        try {
            ...
            System.err.println("!!! keysFirstClientAlpha is " + keysFirstClientAlpha);
            final long firstFailingKeyForCrashCase = keysFirstClientAlpha.iterator().next();
            System.err.println("!!! firstFailingKeyForCrashCase is " + firstFailingKeyForCrashCase);
            ...
            final Set<Long> keysSecondClientAlphaTwo = keysFromInstance(streams2AlphaTwo);
            System.err.println("!!! keysSecondClientAlphaTwo is " + keysSecondClientAlphaTwo);
            final long secondFailingKeyForCrashCase = keysSecondClientAlphaTwo.iterator().next();
            System.err.println("!!! secondFailingKeyForCrashCase is " + secondFailingKeyForCrashCase);
